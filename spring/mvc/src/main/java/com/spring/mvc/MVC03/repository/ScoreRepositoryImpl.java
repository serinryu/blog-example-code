...
public class ScoreRepositoryImpl implements ScoreRepository {
    ...
    private static final Map<Integer, Score> scoreMap; // key : 학번, value : 성적정보

    private static int sequence; // primary key로 사용할 학번번호, 0으로 자동 초기화

    // 정적변수를 초기화해줄 정적 블록
    // 실제 DB 를 사용하지 않고 임시적으로 In-memory 를 사용중인것 -> 따라서, 서버를 껐다가 키면 기존 수정된 내용 유실
    static {
